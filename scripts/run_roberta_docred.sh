...
# Specify the path to your pre-trained RoBERTa model
# Please replace {Your pre-trained RoBERTa path} with the actual path
MODEL_NAME_OR_PATH="{Your pre-trained RoBERTa path}"
...
--eta 0.3 \
--gamma 50.0 > ./logs/DocRED_roberta.log 2>&1 &